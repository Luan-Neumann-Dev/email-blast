...
use function Pest\Laravel\{assertDatabaseCount, post, get};
...
test('when sending late the send at should be required', function () {
...
test('after everything whe should redirect to campaign index route', function () {
    post($this->route, ['send_when' => 'now'])
